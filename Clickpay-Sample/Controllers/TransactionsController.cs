...
using Clickpay_Sample.Data;
using Clickpay_Sample.Helpers;
using Clickpay_Sample.Models;

namespace Clickpay_Sample.Controllers
{
    public class TransactionsController : Controller
    {
        private readonly Clickpay_SampleContext _context;

        public TransactionsController(Clickpay_SampleContext context)
        {
            _context = context;
        }
